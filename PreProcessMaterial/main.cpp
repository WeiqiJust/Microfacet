...
void sample_BlinnPhong()
{
...

	{
		...
		compute_color_matrix(M, 16, 256, 16, 256, &brdf);
		//compute_color_matrix(M, 16, 1, 16, 1, &brdf);
		cout << "after comput color matrix" << endl;
		M = M * 12;
...
void sample_Ward()
{
	...
	//	preconv_matr_rp_brdf("T:/ProMaterial/material/Ward_0.50_log", 
	//		30, 16,
	//		15, 64, DEFAULT_AREA_SAMPLES, &brdf, 
	//		200, SVD_QUALITY, M);
	//}
	...
	//	preconv_matr_rp_brdf("T:/ProMaterial/material/Ward_0.40_log", 
	//		37, 8,
	//		19,	64, DEFAULT_AREA_SAMPLES, &brdf, 
	//		400, SVD_QUALITY, M);
	//}

	{
		...
		//int dim_n, dim_brdf;
		//test_sampling_rate(dim_n, dim_brdf, &brdf, M, 20, 17);
		preconv_matr_rp_brdf("T:/ProMaterial/material/Ward_0.30_log", 
			48, 4,
			22, 64, DEFAULT_AREA_SAMPLES, &brdf, 
			600, SVD_QUALITY, M);
	}
	...
	//	//int dim_n, dim_brdf;
	//	//test_sampling_rate(dim_n, dim_brdf, &brdf, M, 20, 17);
	//	preconv_matr_rp_brdf("T:/ProMaterial/material/Ward_0.20_log", 
	//		63, 4,
...
void sample_CT()
{
...

	{
		...
		preconv_matr_rp_brdf("T:/ProMaterial/material/CT_0.5_log", 
			30, 16,
			19, 64, DEFAULT_AREA_SAMPLES, &brdf, 
			200, SVD_QUALITY, M);
	}

	{
		...
		preconv_matr_rp_brdf("T:/ProMaterial/material/CT_0.4_log", 
			34, 16,
			22, 64, DEFAULT_AREA_SAMPLES, &brdf, 
			240, SVD_QUALITY, M);
	}

	{
		...
		preconv_matr_rp_brdf("T:/ProMaterial/material/CT_0.3_log", 
			44, 8,
			30, 32, DEFAULT_AREA_SAMPLES, &brdf, 
			320, SVD_QUALITY, M);
	}

	{
		...
		preconv_matr_rp_brdf("T:/ProMaterial/material/CT_0.2_log", 
			63, 2,
